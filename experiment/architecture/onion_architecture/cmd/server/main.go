...
import (
	...
	"github.com/sky0621/tips-go/experiment/architecture/onion_architecture/internal/infrastructure/persistence/mysql"
	"github.com/sky0621/tips-go/experiment/architecture/onion_architecture/internal/infrastructure/web/handler"
	"log"
	"os"
	"time"
...
func main() {
	...
	todoUsecase := service.NewTodo(repo)
