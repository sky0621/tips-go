...
import (
	...
	"github.com/sky0621/tips-go/experiment/architecture/clean_architecture/internal/infrastructure/db"
...
func NewTodoRepository(dbConn *sql.DB) usecase.TodoRepository {
