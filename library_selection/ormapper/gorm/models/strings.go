...
func (u User) String() string {
	...
	builder.WriteString(fmt.Sprintf("DeletedAt: %v, ", u.DeletedAt))
...
func (p Post) String() string {
	...
	builder.WriteString(fmt.Sprintf("DeletedAt: %v, ", p.DeletedAt))
...
func (c Comment) String() string {
	...
	builder.WriteString(fmt.Sprintf("DeletedAt: %v, ", c.DeletedAt))
	builder.WriteString("}")
	return builder.String()
}
